...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" <?= $pageName=='base' ? 'active' : ''  ?> href="/TimeTravel/index.php">TimeTravel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" <?= $pageName=='list' ? 'active' : ''  ?> href="/TimeTravel/product/product-list.php">商品列表</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 ml-auto">
                    ...
                    <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link"><?= $_SESSION['admin']['email'] ?></a>
                        </li>
                        <li class="nav-item">
